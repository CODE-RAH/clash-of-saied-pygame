...
در این بازی کنترل شخصیت **سعید** را برعهده می‌گیرید و باید با پرش از موانع و شلیک به دشمنان، بیشترین تعداد **Kill** را ثبت کنید.
...
```bash
git clone https://github.com/CODE-RAH/clash-of-saied-pygame.git
cd clash-of-saied-pygame
````

### دانلود مستقیم

روی دکمه **Code** کلیک کرده و گزینه **Download ZIP** را انتخاب کنید.
...
هنگام نصب Python گزینه زیر را فعال کنید:
...
برای دنبال کردن پروژه‌های جدید و آموزش‌های تخصصی CODE RAH ما را دنبال کنید.
